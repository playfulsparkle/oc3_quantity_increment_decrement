...
const outputPath = path.join(__dirname, "/dist/ps_quantity_increment_decrement.ocmod.zip");
...
output.on("close", function () {
  ...
  console.log("ps_quantity_increment_decrement.ocmod.zip has been created");
