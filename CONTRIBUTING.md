...
1. Review the [existing issues](https://github.com/playfulsparkle/oc3_quantity_increment_decrement/issues) to avoid duplicates.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc3_quantity_increment_decrement/issues)
